...
<div class="hero" style="background-image: url('{{ asset('frontend/images/hero_1_a.jpg') }}')">
            ...
            <div class="col-lg-10">
              <div class="row mb-5">
                <div class="col-lg-7 intro">
                  <h1><strong>Sewa Mobil</strong> Ditempat Kami Dengan Harga Yang Pas. </h1>
                </div>
              </div>
      ...
      <div class="site-section">
        <div class="container">
          ...
          <div class="row mb-5">
            ...
            <div class="col-lg-4 mb-4 mb-lg-0" data-aos="fade-up" data-aos-duration="1500">
              <div class="step">
                <span>2</span>
                <div class="step-inner">
            ...
            <div class="col-lg-4 mb-4 mb-lg-0" data-aos="fade-up" data-aos-duration="2000">
              <div class="step">
                <span>3</span>
                <div class="step-inner">
      ...
      <div class="site-section">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-7 text-center order-lg-2" data-aos="zoom-out-left">
      ...
      <div class="site-section bg-light">
        <div class="container">
          ...
          @forelse($cars as $car)
            ...
            @empty
                <p class="display-4 text-center mx-auto">Data Kosong!</p>
            @endforelse
          </div>
        </div>
      </div>
