              ...
              <div class="card-body">
                <form method="post" action="{{ route('admin.cars.update', $car) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row border-bottom pb-4">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control @error('nama_mobil') is-invalid @enderror" name="nama_mobil" value="{{ old('nama_mobil', $car->nama_mobil) }}" id="nama_mobil">
                          @error('nama_mobil')
                    ...
                    <div class="form-group row border-bottom pb-4">
                        ...
                        <div class="col-sm-10">
                          <input type="number" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price', $car->price) }}" id="price">
                          @error('price')
                                <div class="invalid-tooltip">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group row border-bottom pb-4">
                        ...
                        <div class="col-sm-10">
                          <input type="number" class="form-control @error('penumpang') is-invalid @enderror" name="pintu" value="{{ old('pintu', $car->pintu) }}" id="pintu">
                        </div>
                    </div>
                    <div class="form-group row border-bottom pb-4">
                    ...
                    <div class="form-group row border-bottom pb-4">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" cols="30" rows="6">{{ old('description', $car->description) }}</textarea>
                            @error('description')
                            <div class="invalid-tooltip">
                                {{ $message }}
                            </div>
